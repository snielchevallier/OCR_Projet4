                    ...
                    <div class="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-5 pb-10">
                         <div class="bg-white py-12 px-5 justify-items-center rounded-lg md:ps-16 md:pe-20">
                            ...
                            <?php if ($user->getPhoto()): ?>
                               <img src="<?= UPLOADS_URL ?>users/<?=$user->getPhoto()?>" class="w-32 h-32 rounded-full" alt="<?=$user->getPseudo()?>">
                            <?php else: ?>
                                <img src="<?= ASSETS_PATH ?>img/icon-profile-default" class="w-32 h-32 rounded-full" alt="<?=$user->getPseudo()?>">
                            <?php endif; ?>
                            <div class="pt-5">
                                <hr class="px-24">
                            </div>
